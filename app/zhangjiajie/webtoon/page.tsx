...
type Course = "3n4d" | "4n5d";

const WEBTOON_BASE_URL =
  "https://eqzrecpphisfqqqvsmjq.supabase.co/storage/v1/object/public/gallery/gallery/destinations/zhangjiajie/webtoon/";

const webtoons: Record<Course, string[]> = {
  "3n4d": [
    "zhangjiajie3n4d1.png",
    "zhangjiajie3n4d2.png",
    "zhangjiajie3n4d3.png",
    "zhangjiajie3n4d4.png",
  ],
  "4n5d": [
    "zhangjiajie4n5d1.png",
    "zhangjiajie4n5d2.png",
    "zhangjiajie4n5d3.png",
    "zhangjiajie4n5d4.png",
    "zhangjiajie4n5d5.png",
  ],
};

export default function ZhangjiajieWebtoonPage() {
  const [course, setCourse] = useState<Course>("3n4d");
