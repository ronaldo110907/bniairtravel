...
export const excludesValue3 = [
  ...
  {
    id: 2,
    text: "선택관광 비용(약200$)\n중구산케이블카(50$),민남전기쇼OR링링서커스(50$),발+전신마사지90분(60$),요트체험(50$),일월곡온천욕(60$),야경유란선(60$)..등",
  },
  { id: 3, text: "매너팁 및 기타 개인경비" },
  { id: 4, text: "싱글차지 120,000원 / 1인(3박)" },
  { id: 5, text: "단독행사기준 노쇼핑시-1인 50$ 추가" },
];
...
export const includesPremium3 = [
  ...
  {
    id: 3,
    text: "전 일정 식사 · 특식6회(쇼우딤섬, 호남요리, 동북요리, 삼겹살 무제한, 토루객가요리(남정호텔), 항주요리)",
  },
  { id: 4, text: "전용차량" },
  { id: 5, text: "관광지 입장료 · 여행자보험(2억원)" },
  {
    id: 6,
    text: "특전[발+전신마사지 90분 1회(매너팁별도), 숙장화원(전동카 편도),민남전기쇼, 신야경 유람선]",
  },
  { id: 7, text: "기사 · 가이드팁" },
];
...
export const excludesPremium3 = [
  { id: 1, text: "마사지 매너팁" },
  { id: 2, text: "기타 개인경비" },
  { id: 3, text: "싱글차지 160,000 / 1인(3박)" },
  { id: 4, text: "단독행사기준 노쇼핑시-1인 50$ 추가" },
];
...
export const excludesValue4 = [
  ...
  {
    id: 2,
    text: "선택관광 비용(약250$)\n중구산케이블카(50$),민남전기쇼OR링링서커스(50$),발+전신마사지90분(60$),요트체험(50$),일월곡온천욕(60$),야경유란선(60$),원림식물원(40$),위젠민남민속촌(40$),해물요리(50$)..등",
  },
  { id: 3, text: "매너팁 및 기타 개인경비" },
  { id: 4, text: "싱글차지 160,000원 / 1인(4박)" },
  { id: 5, text: "단독행사기준 노쇼핑시-1인 50$ 추가" },
];
...
export const includesWuyishan4 = [
  ...
  {
    id: 3,
    text: "전 일정 식사 · 특식8회(쇼우딤섬, 호남요리, 동북요리, 버섯요리, 삼겹살 무제한, 농가요리, 토루객가요리(남정호텔), 샤브샤브 무제한)",
  },
  { id: 4, text: "전용차량" },
  { id: 5, text: "관광지 입장료 · 여행자보험(2억원)" },
  {
...
export const includesGolf3 = [
  ...
  { id: 3, text: "전용차량" },
  { id: 4, text: "조식+특석식3회(샤브샤브-하이디라오,한식,삼겹살무제한)" },
  { id: 5, text: "여행자보험(2억원)" },
...
export const excludesGolf3 = [
  { id: 1, text: "클럽 중식 약 20$ ~ 1끼/인~" },
  {
    id: 2,
    text: "캐디팁(2인 1캐디) 18홀 150위안 / 1인",
  },
  { id: 3, text: "기타 개인경비" },
  { id: 4, text: "싱글차지 160,000원 / 1인(3박)" },
];
...
export const faqs = [
  ...
  },
  {
    ...
    answer:
      "샤먼 일정은 정5성급 호텔 2인1실 기준이며, 하문+무이산 상품은 샤먼 정5성급 호텔과 무이산 준5성급 호텔을 이용합니다.",
  },
  {
    id: 7,
    question: "싱글룸 이용 시 추가요금이 있나요?",
    answer:
      "네. 3박5일은 상품에 따라 실속 120,000원~/인, 실속 4박6일은 160,000원/인, 하문+무이산 4박6일은 200,000원/인 기준입니다.",
  },
  {
    id: 8,
    question: "골프상품에는 어떤 비용이 별도인가요?",
    answer:
      "클럽 중식, 캐디팁, 기타 개인경비가 별도입니다. 상세 금액은 선택하신 골프 일정의 불포함 사항에서 확인할 수 있습니다.",
  },
  {
    id: 9,
