...
export default async function GuilinPage() {
    ...
    <main className="min-h-screen overflow-x-hidden bg-[#f7f3ec] pb-24 text-[#1f1f1f] lg:pb-0">
      ...
      <SectionReveal className="relative z-20 mx-auto -mt-16 max-w-3xl px-6">
        <div className="overflow-hidden rounded-[36px] bg-white p-5 shadow-2xl">
          <img
            src="https://eqzrecpphisfqqqvsmjq.supabase.co/storage/v1/object/public/gallery/poster/guilin.png"
            alt="계림 상품 안내 포스터"
      ...
      <div className="mt-10">
        <StickyBookingBar
          ...
          price="출발일 확인"
          pdfFile="/files/guilin.pdf"
          hwpFile="/files/guilin.hwp"
        />
      </div>
